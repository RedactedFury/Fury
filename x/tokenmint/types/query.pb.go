...
func init() {
	proto.RegisterType((*QueryAllTokenMintedForAllAppsRequest)(nil), "fury.tokenmint.v1beta1.QueryAllTokenMintedForAllAppsRequest")
	proto.RegisterType((*QueryAllTokenMintedForAllAppsResponse)(nil), "fury.tokenmint.v1beta1.QueryAllTokenMintedForAllAppsResponse")
	proto.RegisterType((*QueryTokenMintedByAppRequest)(nil), "fury.tokenmint.v1beta1.QueryTokenMintedByAppRequest")
	proto.RegisterType((*QueryTokenMintedByAppResponse)(nil), "fury.tokenmint.v1beta1.QueryTokenMintedByAppResponse")
	proto.RegisterType((*QueryTokenMintedByAppAndAssetRequest)(nil), "fury.tokenmint.v1beta1.QueryTokenMintedByAppAndAssetRequest")
	proto.RegisterType((*QueryTokenMintedByAppAndAssetResponse)(nil), "fury.tokenmint.v1beta1.QueryTokenMintedByAppAndAssetResponse")
}

func init() {
	proto.RegisterFile("fury/tokenmint/v1beta1/query.proto", fileDescriptor_47c1a33cde9c8705)
}
...
func (c *queryClient) QueryAllTokenMintedForAllApps(ctx context.Context, in *QueryAllTokenMintedForAllAppsRequest, opts ...grpc.CallOption) (*QueryAllTokenMintedForAllAppsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.tokenmint.v1beta1.Query/QueryAllTokenMintedForAllApps", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryTokenMintedByApp(ctx context.Context, in *QueryTokenMintedByAppRequest, opts ...grpc.CallOption) (*QueryTokenMintedByAppResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.tokenmint.v1beta1.Query/QueryTokenMintedByApp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryTokenMintedByAppAndAsset(ctx context.Context, in *QueryTokenMintedByAppAndAssetRequest, opts ...grpc.CallOption) (*QueryTokenMintedByAppAndAssetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.tokenmint.v1beta1.Query/QueryTokenMintedByAppAndAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_QueryAllTokenMintedForAllApps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.tokenmint.v1beta1.Query/QueryAllTokenMintedForAllApps",
	}
...
func _Query_QueryTokenMintedByApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.tokenmint.v1beta1.Query/QueryTokenMintedByApp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_QueryTokenMintedByAppAndAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.tokenmint.v1beta1.Query/QueryTokenMintedByAppAndAsset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.tokenmint.v1beta1.Query",
	...
	Metadata: "fury/tokenmint/v1beta1/query.proto",
}
