...
// source: fury/tokenmint/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgMintNewTokensRequest)(nil), "fury.tokenmint.v1beta1.MsgMintNewTokensRequest")
	proto.RegisterType((*MsgMintNewTokensResponse)(nil), "fury.tokenmint.v1beta1.MsgMintNewTokensResponse")
}

func init() { proto.RegisterFile("fury/tokenmint/v1beta1/tx.proto", fileDescriptor_877e0eff92180c18) }
...
func (c *msgClient) MsgMintNewTokens(ctx context.Context, in *MsgMintNewTokensRequest, opts ...grpc.CallOption) (*MsgMintNewTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.tokenmint.v1beta1.Msg/MsgMintNewTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_MsgMintNewTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.tokenmint.v1beta1.Msg/MsgMintNewTokens",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.tokenmint.v1beta1.Msg",
	...
	Metadata: "fury/tokenmint/v1beta1/tx.proto",
}
