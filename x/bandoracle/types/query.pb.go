...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "fury.bandoracle.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "fury.bandoracle.v1beta1.QueryParamsResponse")
	proto.RegisterType((*QueryFetchPriceRequest)(nil), "fury.bandoracle.v1beta1.QueryFetchPriceRequest")
	proto.RegisterType((*QueryFetchPriceResponse)(nil), "fury.bandoracle.v1beta1.QueryFetchPriceResponse")
	proto.RegisterType((*QueryLastFetchPriceIdRequest)(nil), "fury.bandoracle.v1beta1.QueryLastFetchPriceIdRequest")
	proto.RegisterType((*QueryLastFetchPriceIdResponse)(nil), "fury.bandoracle.v1beta1.QueryLastFetchPriceIdResponse")
}

func init() {
	proto.RegisterFile("fury/bandoracle/v1beta1/query.proto", fileDescriptor_51b7d3cb3f498405)
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.bandoracle.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) FetchPriceResult(ctx context.Context, in *QueryFetchPriceRequest, opts ...grpc.CallOption) (*QueryFetchPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.bandoracle.v1beta1.Query/FetchPriceResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) LastFetchPriceID(ctx context.Context, in *QueryLastFetchPriceIdRequest, opts ...grpc.CallOption) (*QueryLastFetchPriceIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.bandoracle.v1beta1.Query/LastFetchPriceID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.bandoracle.v1beta1.Query/Params",
	}
...
func _Query_FetchPriceResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.bandoracle.v1beta1.Query/FetchPriceResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_LastFetchPriceID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.bandoracle.v1beta1.Query/LastFetchPriceID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.bandoracle.v1beta1.Query",
	...
	Metadata: "fury/bandoracle/v1beta1/query.proto",
}
