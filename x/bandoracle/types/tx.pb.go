...
// source: fury/bandoracle/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgFetchPriceData)(nil), "fury.bandoracle.v1beta1.MsgFetchPriceData")
	proto.RegisterType((*MsgFetchPriceDataResponse)(nil), "fury.bandoracle.v1beta1.MsgFetchPriceDataResponse")
}

func init() {
	proto.RegisterFile("fury/bandoracle/v1beta1/tx.proto", fileDescriptor_e41ad8b392d8eeff)
}
