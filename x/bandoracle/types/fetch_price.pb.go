...
// source: fury/bandoracle/v1beta1/fetch_price.proto
...
func init() {
	proto.RegisterType((*FetchPriceCallData)(nil), "fury.bandoracle.v1beta1.FetchPriceCallData")
	proto.RegisterType((*FetchPriceResult)(nil), "fury.bandoracle.v1beta1.FetchPriceResult")
	proto.RegisterType((*Market)(nil), "fury.bandoracle.v1beta1.Market")
	proto.RegisterType((*DiscardData)(nil), "fury.bandoracle.v1beta1.DiscardData")
}

func init() {
	proto.RegisterFile("fury/bandoracle/v1beta1/fetch_price.proto", fileDescriptor_419dc3984543857a)
}
