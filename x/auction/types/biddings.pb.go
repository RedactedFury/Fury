...
// source: fury/auction/v1beta1/biddings.proto
...
func init() {
	proto.RegisterType((*SurplusBiddings)(nil), "fury.auction.v1beta1.SurplusBiddings")
	proto.RegisterType((*DebtBiddings)(nil), "fury.auction.v1beta1.DebtBiddings")
	proto.RegisterType((*DutchBiddings)(nil), "fury.auction.v1beta1.DutchBiddings")
}

func init() {
	proto.RegisterFile("fury/auction/v1beta1/biddings.proto", fileDescriptor_a5a3f4b8597bafd2)
}
