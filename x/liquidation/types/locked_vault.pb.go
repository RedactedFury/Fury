...
// source: fury/liquidation/v1beta1/locked_vault.proto
...
func init() {
	proto.RegisterType((*LockedVault)(nil), "fury.liquidation.v1beta1.LockedVault")
	proto.RegisterType((*BorrowMetaData)(nil), "fury.liquidation.v1beta1.BorrowMetaData")
}

func init() {
	proto.RegisterFile("fury/liquidation/v1beta1/locked_vault.proto", fileDescriptor_6e1145b6fa4b74d3)
}
