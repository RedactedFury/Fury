...
// source: fury/liquidation/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgLiquidateVaultRequest)(nil), "fury.liquidation.v1beta1.MsgLiquidateVaultRequest")
	proto.RegisterType((*MsgLiquidateVaultResponse)(nil), "fury.liquidation.v1beta1.MsgLiquidateVaultResponse")
	proto.RegisterType((*MsgLiquidateBorrowRequest)(nil), "fury.liquidation.v1beta1.MsgLiquidateBorrowRequest")
	proto.RegisterType((*MsgLiquidateBorrowResponse)(nil), "fury.liquidation.v1beta1.MsgLiquidateBorrowResponse")
}

func init() {
	proto.RegisterFile("fury/liquidation/v1beta1/tx.proto", fileDescriptor_46d2beddde56424c)
}
...
func (c *msgClient) MsgLiquidateVault(ctx context.Context, in *MsgLiquidateVaultRequest, opts ...grpc.CallOption) (*MsgLiquidateVaultResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidation.v1beta1.Msg/MsgLiquidateVault", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) MsgLiquidateBorrow(ctx context.Context, in *MsgLiquidateBorrowRequest, opts ...grpc.CallOption) (*MsgLiquidateBorrowResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidation.v1beta1.Msg/MsgLiquidateBorrow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_MsgLiquidateVault_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidation.v1beta1.Msg/MsgLiquidateVault",
	}
...
func _Msg_MsgLiquidateBorrow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidation.v1beta1.Msg/MsgLiquidateBorrow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.liquidation.v1beta1.Msg",
	...
	Metadata: "fury/liquidation/v1beta1/tx.proto",
}
