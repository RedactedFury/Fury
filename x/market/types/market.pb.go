...
// source: fury/market/v1beta1/market.proto
...
func init() {
	proto.RegisterType((*TimeWeightedAverage)(nil), "fury.market.v1beta1.TimeWeightedAverage")
}

func init() {
	proto.RegisterFile("fury/market/v1beta1/market.proto", fileDescriptor_c52e410514c538b6)
}
