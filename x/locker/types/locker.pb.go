...
// source: fury/locker/v1beta1/locker.proto
...
func init() {
	proto.RegisterType((*Locker)(nil), "fury.locker.v1beta1.Locker")
	proto.RegisterType((*UserAppAssetLockerMapping)(nil), "fury.locker.v1beta1.UserAppAssetLockerMapping")
	proto.RegisterType((*UserTxData)(nil), "fury.locker.v1beta1.UserTxData")
	proto.RegisterType((*LockerLookupTableData)(nil), "fury.locker.v1beta1.LockerLookupTableData")
	proto.RegisterType((*LockerProductAssetMapping)(nil), "fury.locker.v1beta1.LockerProductAssetMapping")
	proto.RegisterType((*LockedDepositedAmountDataMap)(nil), "fury.locker.v1beta1.LockedDepositedAmountDataMap")
	proto.RegisterType((*LockerTotalRewardsByAssetAppWise)(nil), "fury.locker.v1beta1.LockerTotalRewardsByAssetAppWise")
}

func init() {
	proto.RegisterFile("fury/locker/v1beta1/locker.proto", fileDescriptor_5cf8d15809df39ec)
}
