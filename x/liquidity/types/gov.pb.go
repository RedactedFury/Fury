...
// source: fury/liquidity/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*UpdateGenericParamsProposal)(nil), "fury.liquidity.v1beta1.UpdateGenericParamsProposal")
	proto.RegisterType((*CreateNewLiquidityPairProposal)(nil), "fury.liquidity.v1beta1.CreateNewLiquidityPairProposal")
}

func init() {
	proto.RegisterFile("fury/liquidity/v1beta1/gov.proto", fileDescriptor_117e1f5baeb7b742)
}
