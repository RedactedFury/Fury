...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&UpdateGenericParamsProposal{}, "fury/UpdateGenericParams")
	govtypes.RegisterProposalTypeCodec(&CreateNewLiquidityPairProposal{}, "fury/CreateNewLiquidityPair")
}
