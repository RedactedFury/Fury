...
// source: fury/liquidity/v1beta1/liquidity.proto
...
type DepositRequest struct {
	...
	Status         RequestStatus                            `protobuf:"varint,8,opt,name=status,proto3,enum=fury.liquidity.v1beta1.RequestStatus" json:"status,omitempty"`
	AppId          uint64                                   `protobuf:"varint,9,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`
}
...
type WithdrawRequest struct {
	...
	Status         RequestStatus                            `protobuf:"varint,7,opt,name=status,proto3,enum=fury.liquidity.v1beta1.RequestStatus" json:"status,omitempty"`
	AppId          uint64                                   `protobuf:"varint,8,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`
}
...
type Order struct {
	...
	Direction OrderDirection `protobuf:"varint,5,opt,name=direction,proto3,enum=fury.liquidity.v1beta1.OrderDirection" json:"direction,omitempty"`
	...
	Status   OrderStatus `protobuf:"varint,14,opt,name=status,proto3,enum=fury.liquidity.v1beta1.OrderStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("fury.liquidity.v1beta1.OrderDirection", OrderDirection_name, OrderDirection_value)
	proto.RegisterEnum("fury.liquidity.v1beta1.RequestStatus", RequestStatus_name, RequestStatus_value)
	proto.RegisterEnum("fury.liquidity.v1beta1.OrderStatus", OrderStatus_name, OrderStatus_value)
	proto.RegisterEnum("fury.liquidity.v1beta1.AddressType", AddressType_name, AddressType_value)
	proto.RegisterType((*Pair)(nil), "fury.liquidity.v1beta1.Pair")
	proto.RegisterType((*Pool)(nil), "fury.liquidity.v1beta1.Pool")
	proto.RegisterType((*DepositRequest)(nil), "fury.liquidity.v1beta1.DepositRequest")
	proto.RegisterType((*WithdrawRequest)(nil), "fury.liquidity.v1beta1.WithdrawRequest")
	proto.RegisterType((*Order)(nil), "fury.liquidity.v1beta1.Order")
	proto.RegisterType((*ActiveFarmer)(nil), "fury.liquidity.v1beta1.ActiveFarmer")
	proto.RegisterType((*QueuedCoin)(nil), "fury.liquidity.v1beta1.QueuedCoin")
	proto.RegisterType((*QueuedFarmer)(nil), "fury.liquidity.v1beta1.QueuedFarmer")
}

func init() {
	proto.RegisterFile("fury/liquidity/v1beta1/liquidity.proto", fileDescriptor_579dcc42096fa86d)
}
