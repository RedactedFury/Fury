...
// source: fury/asset/v1beta1/extendedPairVault.proto
...
func init() {
	proto.RegisterType((*ExtendedPairVault)(nil), "fury.asset.v1beta1.ExtendedPairVault")
}

func init() {
	proto.RegisterFile("fury/asset/v1beta1/extendedPairVault.proto", fileDescriptor_23dd38fcddb231cd)
}
