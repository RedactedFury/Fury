...
// source: fury/asset/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "fury.asset.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("fury/asset/v1beta1/genesis.proto", fileDescriptor_13a69a7476a1f579)
}
