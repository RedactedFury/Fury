...
// source: fury/asset/v1beta1/pair.proto
...
func init() {
	proto.RegisterType((*Pair)(nil), "fury.asset.v1beta1.Pair")
	proto.RegisterType((*PairInfo)(nil), "fury.asset.v1beta1.PairInfo")
}

func init() { proto.RegisterFile("fury/asset/v1beta1/pair.proto", fileDescriptor_65bd24918e5ac160) }
