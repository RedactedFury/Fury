...
Sample json content
{
	...
	"title" :"Add assets for applications to be deployed on fury testnet",
	"description" :"This proposal it to add following assets ATOM to be then used on harbor, commodo and calma apps",
