...
// source: fury/vault/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "fury.vault.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("fury/vault/v1beta1/genesis.proto", fileDescriptor_00ed468466e13f8a)
}
