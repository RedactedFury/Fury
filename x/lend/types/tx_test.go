...
func TestNewMsgLend(t *testing.T) {
	testCases := []struct {
		...
		{
			name:     "empty from",
			msg:      types.NewMsgLend("", 1, sdk.NewCoin("ufury", sdk.NewInt(1000000)), 1, 1),
			isErrExp: true,
		},
		{
			name: "amountIn zero",
			msg: types.NewMsgLend(
				...
				1,
				sdk.NewCoin("ufury", sdk.NewInt(0)),
				1,
				1,
			),
			isErrExp: true,
		},
		{
			...
			msg: types.NewMsgLend(
				"cosmos1yq8lgssgxlx9smjhes6ryjasmqmd3ts2559g0t",
				0,
				sdk.NewCoin("ufury", sdk.NewInt(1000000)),
				1,
				1,
			),
			isErrExp: true,
	...
	testCases := []struct {
	...
	}{
		{
			...
			msg: &types.MsgDraw{
				Borrower: "",
				BorrowId: 1,
				Amount:   sdk.NewCoin("ufury", sdk.NewInt(1000000)),
			},
			isErrExp: true,
		},
		{
		...
		},
		{
			...
			msg: &types.MsgDraw{
				Borrower: "cosmos1yq8lgssgxlx9smjhes6ryjasmqmd3ts2559g0t",
				BorrowId: 1,
				Amount:   sdk.NewCoin("ufury", sdk.NewInt(0)),
			},
			isErrExp: true,
		},
		{
