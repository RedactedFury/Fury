...
// source: fury/rewards/v1beta1/gauge.proto
...
func init() {
	proto.RegisterType((*LiquidtyGaugeMetaData)(nil), "fury.rewards.v1beta1.LiquidtyGaugeMetaData")
	proto.RegisterType((*Gauge)(nil), "fury.rewards.v1beta1.Gauge")
	proto.RegisterType((*GaugeByTriggerDuration)(nil), "fury.rewards.v1beta1.GaugeByTriggerDuration")
}

func init() {
	proto.RegisterFile("fury/rewards/v1beta1/gauge.proto", fileDescriptor_f71b41b4b0f8e223)
}
