...
// source: fury/rewards/v1beta1/epochs.proto
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "fury.rewards.v1beta1.EpochInfo")
}

func init() {
	proto.RegisterFile("fury/rewards/v1beta1/epochs.proto", fileDescriptor_6f11e4baf2d58b38)
}
