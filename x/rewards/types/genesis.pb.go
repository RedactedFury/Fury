...
// source: fury/rewards/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "fury.rewards.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("fury/rewards/v1beta1/genesis.proto", fileDescriptor_cdfc05d0f3c33bb6)
}
